...
<section class="featured">
    <div class="container featured__container">
        <div class="post__thumbnail">
           <a href="<?= ROOT_URL ?>post.php?id=<?= $featured['id'] ?>"> <img src="./images/<?= $featured['thumbnail'] ?>"></a>
        </div>
        <div class="post__info">
            ...
            <p class="post__body">
            <?= substr($featured['body'], 0, 300) ?><a href="<?= ROOT_URL ?>post.php?id=<?= $featured['id'] ?>"> <b>...</b></a>
           </p>
...
<section class="posts <?= $featured ? '' : 'section__extra-margin' ?> ">
    <div class="container posts__container">
        ...
        <article class="post">
            ...
            <p class="post__body">
            <?= substr($post['body'], 0, 150) ?><a href="<?= ROOT_URL ?>post.php?id=<?= $post['id'] ?>"> <b>...</b></a>
            </p>
            <div class="post__author">
            <?php
                // fetch author from users table using author_id
